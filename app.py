...
[data-testid="stFileUploader"] { color: #9db89e; }
...
def predict(img: Image.Image, model, class_names):
    ...
    return preds, top3_idx, class_names
...
if uploaded:
    ...
    with col2:
        with st.spinner('Analyzing...'):
            preds, top3_idx, class_names = predict(img, model, class_names)
        ...
        <div class="result-card">
            ...
            <div class="result-disease">{format_class_name(top1_name)}</div>
